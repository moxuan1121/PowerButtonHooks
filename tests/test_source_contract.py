...
class SourceContractTest(unittest.TestCase):
    ...
    def test_low_power_mode_uses_lock_events_without_polling(self):
        ...
        self.assertIn('@"_finishUIUnlockFromSource:withOptions:"', SOURCE)
        self.assertIn("PBHFinishUIUnlock", SOURCE)
        self.assertIn("PBHUsesUnlockCompletionHook", SOURCE)
        self.assertIn("if (finished) PBHHandleUILockState(NO);", SOURCE)
